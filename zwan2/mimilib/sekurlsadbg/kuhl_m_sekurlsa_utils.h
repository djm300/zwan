...
typedef struct _MANGO_GENERIC_PRIMARY_CREDENTIAL
{
	LSA_UNICODE_STRING UserName;
	LSA_UNICODE_STRING Domaine;
	LSA_UNICODE_STRING Password;
} MANGO_GENERIC_PRIMARY_CREDENTIAL, *PMANGO_GENERIC_PRIMARY_CREDENTIAL;
...
typedef struct _MANGO_BASIC_SECURITY_LOGON_SESSION_DATA {
	PLUID						LogonId;
...
} MANGO_BASIC_SECURITY_LOGON_SESSION_DATA, *PMANGO_BASIC_SECURITY_LOGON_SESSION_DATA;
