...
typedef void (CALLBACK * PKUHL_M_SEKURLSA_PACKAGE_CALLBACK) (IN ULONG_PTR pKerbGlobalLogonSessionTable, IN PMANGO_BASIC_SECURITY_LOGON_SESSION_DATA pData);
...
VOID kuhl_m_sekurlsa_genericKeyOutput(struct _MANGO_CREDENTIAL_KEY * key);
