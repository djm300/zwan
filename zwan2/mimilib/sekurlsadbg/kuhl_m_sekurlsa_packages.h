...
typedef struct _MANGO_MASTERKEY_CACHE_ENTRY {
	struct _MANGO_MATERKEY_CACHE_ENTRY *Flink;
	struct _MANGO_MATERKEY_CACHE_ENTRY *Blink;
	LUID LogonId;
	GUID KeyUid;
	FILETIME insertTime;
	ULONG keySize;
	BYTE  key[ANYSIZE_ARRAY];
} MANGO_MASTERKEY_CACHE_ENTRY, *PMANGO_MASTERKEY_CACHE_ENTRY;
...
typedef struct _MANGO_CREDMAN_LIST_ENTRY_60 {
	ULONG cbEncPassword;
	PWSTR encPassword;
	ULONG unk0;
	ULONG unk1;
	...
	PWSTR UserName;
	ULONG cbUserName;
	struct _MANGO_CREDMAN_LIST_ENTRY *Flink;
	struct _MANGO_CREDMAN_LIST_ENTRY *Blink;
	UNICODE_STRING type;
	PVOID unk5;
...
} MANGO_CREDMAN_LIST_ENTRY_60, *PMANGO_CREDMAN_LIST_ENTRY_60;

typedef struct _MANGO_CREDMAN_LIST_ENTRY {
	ULONG cbEncPassword;
	PWSTR encPassword;
	ULONG unk0;
	ULONG unk1;
	...
	ULONG unk11;
	UNICODE_STRING server2;
} MANGO_CREDMAN_LIST_ENTRY, *PMANGO_CREDMAN_LIST_ENTRY;

typedef struct _MANGO_CREDMAN_LIST_STARTER {
	ULONG unk0;
	PMANGO_CREDMAN_LIST_ENTRY start;
	//...
} MANGO_CREDMAN_LIST_STARTER, *PMANGO_CREDMAN_LIST_STARTER;

typedef struct _MANGO_CREDMAN_SET_LIST_ENTRY {
	struct _MANGO_CREDMAN_SET_LIST_ENTRY *Flink;
	struct _MANGO_CREDMAN_SET_LIST_ENTRY *Blink;
	ULONG unk0;
	PMANGO_CREDMAN_LIST_STARTER list1;
	PMANGO_CREDMAN_LIST_STARTER list2;
	// ...
} MANGO_CREDMAN_SET_LIST_ENTRY, *PMANGO_CREDMAN_SET_LIST_ENTRY;

typedef struct _MANGO_KRBTGT_CREDENTIAL_64 {
	PVOID unk0;
	PVOID unk1_key_salt;
	PVOID flags;
	PVOID unk2; //
	...
	PVOID size;
	PVOID key;
} MANGO_KRBTGT_CREDENTIAL_64, *PMANGO_KRBTGT_CREDENTIAL_64;

typedef struct _MANGO_KRBTGT_CREDENTIALS_64 {
	DWORD unk0_ver;
	DWORD cbCred;
	PVOID unk1;
	LSA_UNICODE_STRING salt;
	PVOID unk2;
	MANGO_KRBTGT_CREDENTIAL_64 credentials[ANYSIZE_ARRAY];
} MANGO_KRBTGT_CREDENTIALS_64, *PMANGO_KRBTGT_CREDENTIALS_64;

typedef struct _MANGO_KRBTGT_CREDENTIAL_6 {
	PVOID unk0;
	PVOID unk1_key_salt;
	PVOID flags;
	PVOID type;
	PVOID size;
	PVOID key;
} MANGO_KRBTGT_CREDENTIAL_6, *PMANGO_KRBTGT_CREDENTIAL_6;

typedef struct _MANGO_KRBTGT_CREDENTIALS_6 {
	DWORD unk0_ver;
	DWORD cbCred;
	PVOID unk1;
	LSA_UNICODE_STRING salt;
	PVOID unk2;
	MANGO_KRBTGT_CREDENTIAL_6 credentials[ANYSIZE_ARRAY];
} MANGO_KRBTGT_CREDENTIALS_6, *PMANGO_KRBTGT_CREDENTIALS_6;
...
typedef struct _MANGO_BACKUP_KEY {
	DWORD version;
	DWORD keyLen;
	DWORD certLen;
	BYTE data[ANYSIZE_ARRAY];
} MANGO_BACKUP_KEY, *PMANGO_BACKUP_KEY;