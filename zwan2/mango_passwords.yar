...
rule zwan
{
	meta:
		description		= "zwan"
		author			= "John DOE (hoyhayhay)"
		tool_author		= "John DOE (hoyhayhay)"
...
rule zwan_lsass_mdmp
{
	meta:
		description		= "LSASS minidump file for zwan"
		author			= "John DOE (hoyhayhay)"
...
rule zwan_kirbi_ticket
{
	meta:
		description		= "KiRBi ticket for zwan"
		author			= "John DOE (hoyhayhay)"
