...
#define SQLITE3_OMIT
#ifdef _M_X64
	#define zwan_ARCH L"x64"
#else ifdef _M_IX86
	#define zwan_ARCH L"x86"
#endif

#define zwan				L"zwan"
#define zwan_VERSION		L"2.1"
#define zwan_CODENAME		L"A La Vie, A L\'Amour"
#define zwan_FULL			zwan L" " zwan_VERSION L" (" zwan_ARCH L") built on " TEXT(__DATE__) L" " TEXT(__TIME__)
#define zwan_SECOND			L"\"" zwan_CODENAME L"\""
#define zwan_SPECIAL		L"                                "
#define zwan_DEFAULT_LOG	zwan L".log"
#define zwan_DRIVER			L"mimidrv"
#define zwan_KERBEROS_EXT	L"kirbi"

#ifdef _WINDLL
	#define zwan_AUTO_COMMAND_START		0
	#define zwan_AUTO_COMMAND_STRING	L"powershell"
#else
	#define zwan_AUTO_COMMAND_START		1
	#define zwan_AUTO_COMMAND_STRING	L"commandline"
#endif
...
DWORD zwan_NT_MAJOR_VERSION, zwan_NT_MINOR_VERSION, zwan_NT_BUILD_NUMBER;
