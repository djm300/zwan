...
KKLL_M_MEMORY_GENERIC ThreadReferences[] = {
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Thread), PTRN_W23_Thread},				L"PsReferencePrimaryToken",				L"CcSetBcbOwnerPointer",			{ -4,  8}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Thread), PTRN_WVI_Thread},				L"PsDereferenceKernelStack",			L"ExRaiseAccessViolation",			{ -5, 64}},
	{MangoOsIndex_7,			{sizeof(PTRN_WVI_Thread), PTRN_WVI_Thread},				L"RtlUnicodeToMultiByteSize",			L"MmLockPagableSectionByHandle",	{ -5, 64}},
	{MangoOsIndex_8,			{sizeof(PTRN_WVI_Thread), PTRN_WVI_Thread},				L"PsAcquireProcessExitSynchronization",	L"FsRtlAddToTunnelCache",			{ -4, 64}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_WVI_Thread), PTRN_WVI_Thread},				L"ObCreateObject",						L"NtFindAtom",						{ -5, 64}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_Thread), PTRN_W10_Thread},				L"PsRemoveCreateThreadNotifyRoutine",	L"PsRemoveLoadImageNotifyRoutine",	{ -8, 64}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_Thread), PTRN_W10_Thread},				L"PsRemoveCreateThreadNotifyRoutine",	L"PsRemoveLoadImageNotifyRoutine",	{ -8, 64}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_Thread), PTRN_W10_Thread},				L"PsRemoveCreateThreadNotifyRoutine",	L"PsRemoveLoadImageNotifyRoutine",	{ -8, 64}},
};
...
KKLL_M_MEMORY_GENERIC ProcessReferences[] = {
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Process), PTRN_W23_Process},			L"PsReferencePrimaryToken",				L"CcSetBcbOwnerPointer",			{ -4,  8}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Process), PTRN_WVI_Process},			L"SeCreateAccessStateEx",				L"PsReferenceImpersonationToken",	{ -4, 64}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Process), PTRN_WI7_Process},			L"RtlAreAllAccessesGranted",			L"RtlGetIntegerAtom",				{ -4, 64}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Process), PTRN_WI8_Process},			L"PsAcquireProcessExitSynchronization",	L"FsRtlAddToTunnelCache",			{ -4, 64}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Process), PTRN_W81_Process},			L"ObCreateObject",						L"NtFindAtom",						{ -4, 64}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_1507_Process), PTRN_W10_1507_Process},	L"PsSetCreateProcessNotifyRoutine",		L"KeRegisterProcessorChangeCallback",	{ -4, 64}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_1511_Process), PTRN_W10_1511_Process},	L"PsSetCreateProcessNotifyRoutine",		L"KeRegisterProcessorChangeCallback",	{ -4, 64}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_1607_Process), PTRN_W10_1607_Process},	L"PsSetCreateProcessNotifyRoutine",		L"KeRegisterProcessorChangeCallback",	{ -4, 64}},
};
...
KKLL_M_MEMORY_GENERIC ImageReferences[] = {
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Image), PTRN_W23_Image},				L"PsRemoveLoadImageNotifyRoutine",		L"PsSetLegoNotifyRoutine",			{ -4,  8}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Image), PTRN_WVI_Image},				L"NtRequestPort",						L"RtlQueryTimeZoneInformation",		{ -4,  8}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Image), PTRN_WI7_Image},				L"FsRtlReleaseFile",					L"IoSetPartitionInformationEx",		{ -4,  64}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Image), PTRN_WI8_Image},				L"ExSizeOfRundownProtectionCacheAware",	L"MmProbeAndLockProcessPages",		{ -4,  8}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Image), PTRN_W81_Image},				L"PsSetLoadImageNotifyRoutine",			L"PsSetCreateThreadNotifyRoutine",	{ -4,  64}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_Image), PTRN_W10_Image},				L"PsSetLoadImageNotifyRoutine",			L"PsSetCreateProcessNotifyRoutine",	{ -4,  64}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_Image), PTRN_W10_Image},				L"PsSetLoadImageNotifyRoutine",			L"PsSetCreateProcessNotifyRoutine",	{ -4,  64}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_Image), PTRN_W10_Image},				L"PsSetLoadImageNotifyRoutine",			L"SeRegisterLogonSessionTerminatedRoutineEx",	{ -4,  64}},
};
...
KKLL_M_MEMORY_GENERIC ObjectReferences[] = {
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Object), PTRN_W23_Object},				L"ObCreateObjectType",					L"ObReferenceSecurityDescriptor",	{ -4, 0x078, 0x0d8}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Object), PTRN_WVI_Object},				L"ObRegisterCallbacks",					L"ObCreateObjectType",				{ -4, 0x010, 0x070, 0x228}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Object), PTRN_WI7_Object},				L"ObUnRegisterCallbacks",				L"ObCreateObjectType",				{ -4, 0x010, 0x070, 0x0c0}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Object), PTRN_WI8_Object},				L"ObCreateObjectType",					L"IoCreateController",				{ -4, 0x010, 0x070, 0x0c8}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Object), PTRN_W81_Object},				L"ObCreateObjectType",					L"RtlRunOnceInitialize",			{ -4, 0x010, 0x070, 0x0c8}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_Object), PTRN_W10_Object},				L"ObCreateObjectType",					L"RtlRunOnceInitialize",			{ 25, 0x010, 0x070, 0x0c8}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_Object), PTRN_W10_Object},				L"ObCreateObjectType",					L"RtlRunOnceInitialize",			{ 25, 0x010, 0x070, 0x0c8}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_Object), PTRN_W10_Object},				L"ObCreateObjectType",					L"KseRegisterShim",					{ 25, 0x010, 0x070, 0x0c8}},
};
...
KKLL_M_MEMORY_GENERIC RegReferences[] = {
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Reg), PTRN_W23_Reg},				L"CmRegisterCallback",						L"CmUnRegisterCallback",			{  -6}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Reg), PTRN_WVI_Reg},				L"CmUnRegisterCallback",					L"SeSetAuthorizationCallbacks",		{  -9, 0x030}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Reg), PTRN_WI7_Reg},				L"CmUnRegisterCallback",					L"CmRegisterCallback",				{  -9, 0x028}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Reg), PTRN_WI8_Reg},				L"CmSetCallbackObjectContext",				L"CmGetCallbackVersion",			{  -9, 0x028}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Reg), PTRN_W81_Reg},				L"CmSetCallbackObjectContext",				L"DbgkLkmdUnregisterCallback",		{  -9, 0x028}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_Reg), PTRN_W10_Reg},				L"CmUnRegisterCallback",					L"FsRtlAllocateResource",			{ -9, 0x028}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_Reg), PTRN_W10_Reg},				L"CmUnRegisterCallback",					L"FsRtlAllocateResource",			{ -9, 0x028}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_Reg), PTRN_W10_Reg},				L"CmUnRegisterCallback",					L"FsRtlAllocateResource",			{ -9, 0x028}},
};
...
KKLL_M_MEMORY_GENERIC ThreadReferences[] = {	// PspCreateThreadNotifyRoutine
	{MangoOsIndex_XP,		{sizeof(PTRN_WXP_Thread), PTRN_WXP_Thread},			L"NtSetInformationProcess",					L"LdrEnumResources",				{ -4,  8}},
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Thread), PTRN_W23_Thread},			L"NtSetInformationProcess",					L"LdrEnumResources",				{ -4,  8}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Thread), PTRN_WVI_Thread},			L"RtlValidSid",								L"NtOpenThreadTokenEx",				{ -4, 64}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Thread), PTRN_WI7_Thread},			L"RtlCompareUnicodeStrings",				L"ObQueryNameString",				{ -4, 64}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Thread), PTRN_WI8_Thread},			L"PsAssignImpersonationToken",				L"NtFindAtom",						{ -4, 64}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Thread), PTRN_W81_Thread},			L"RtlGetIntegerAtom",						L"PsGetThreadSessionId",			{ -4, 64}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_Thread), PTRN_W10_Thread},			L"PsSetCreateProcessNotifyRoutine",			L"PoRegisterCoalescingCallback",	{ -4, 64}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_Thread), PTRN_W10_Thread},			L"PsSetCreateProcessNotifyRoutine",			L"PoRegisterCoalescingCallback",	{ -4, 64}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_Thread), PTRN_W10_Thread},			L"PsSetCreateProcessNotifyRoutine",			L"PoRegisterCoalescingCallback",	{ -4, 64}},
};
...
KKLL_M_MEMORY_GENERIC ProcessReferences[] = {	// PspCreateProcessNotifyRoutine
	{MangoOsIndex_XP,		{sizeof(PTRN_WXP_Process), PTRN_WXP_Process},		L"NtSetInformationProcess",					L"LdrEnumResources",				{ -4,  8}},
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Process), PTRN_W23_Process},		L"NtSetInformationProcess",					L"LdrEnumResources",				{ -4,  8}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Process), PTRN_WVI_Process},		L"RtlValidSid",								L"NtOpenThreadTokenEx",				{ -4, 64}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Process), PTRN_WI7_Process},		L"RtlCompareUnicodeStrings",				L"ObQueryNameString",				{ -4, 64}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Process), PTRN_WI8_Process},		L"PsAssignImpersonationToken",				L"NtFindAtom",						{ 19, 64}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Process), PTRN_W81_Process},		L"RtlGetIntegerAtom",						L"PsGetThreadSessionId",			{ -4, 64}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_1507_Process), PTRN_W10_1507_Process},	L"PoRegisterCoalescingCallback",		L"RtlGenerateClass5Guid",			{ -4, 64}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_1511_Process), PTRN_W10_1511_Process},	L"PoRegisterCoalescingCallback",		L"RtlGenerateClass5Guid",			{ -4, 64}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_1511_Process), PTRN_W10_1511_Process},	L"PoRegisterCoalescingCallback",		L"PoRequestShutdownEvent",			{ -4, 64}},
};
...
KKLL_M_MEMORY_GENERIC ImageReferences[] = {	// PspLoadImageNotifyRoutine
	{MangoOsIndex_XP,		{sizeof(PTRN_WXP_Image), PTRN_WXP_Image},			L"PsRemoveLoadImageNotifyRoutine",			L"PsCreateSystemProcess",			{  6,  8}},
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Image), PTRN_W23_Image},			L"PsRemoveLoadImageNotifyRoutine",			L"PsCreateSystemThread",			{  6,  8}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Image), PTRN_WVI_Image},			L"RtlUpcaseUnicodeStringToCountedOemString",L"IoCheckShareAccessEx",			{ -4,  8}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Image), PTRN_WI7_Image},			L"RtlCopySidAndAttributesArray",			L"SeImpersonateClientEx",			{ -4,  64}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Image), PTRN_WI8_Image},			L"PsAssignImpersonationToken",				L"NtFindAtom",						{ -4,  8}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Image), PTRN_W81_Image},			L"PsSetLoadImageNotifyRoutine",				L"ObRegisterCallbacks",				{ -4,  64}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_1507_Image), PTRN_W10_1507_Image},	L"PsSetLoadImageNotifyRoutine",				L"RtlGenerateClass5Guid",			{ -4,  64}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_1511_Image), PTRN_W10_1511_Image},	L"PsSetLoadImageNotifyRoutine",				L"RtlGenerateClass5Guid",			{ -4,  64}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_1511_Image), PTRN_W10_1511_Image},	L"PsSetLoadImageNotifyRoutine",				L"PsSetCreateProcessNotifyRoutine",	{ -4,  64}},
};
...
KKLL_M_MEMORY_GENERIC ObjectReferences[] = { // ObpTypeDirectoryObject
	{MangoOsIndex_XP,		{sizeof(PTRN_WXP_Object), PTRN_WXP_Object},			L"ObCreateObjectType",						L"NtOpenThread",					{ -4, 0x040, 0x08c}},
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Object), PTRN_W23_Object},			L"ObCreateObjectType",						L"NtOpenThread",					{ -4, 0x040, 0x08c}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Object), PTRN_WVI_Object},			L"ObCreateObjectType",						L"RtlInvertRangeList",				{ -4, 0x008, 0x058, 0x138}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Object), PTRN_WI7_Object},			L"ObCreateObjectType",						L"RtlInvertRangeList",				{ -4, 0x008, 0x058, 0x080}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Object), PTRN_WI8_Object},			L"ObCreateObjectType",						L"SeTokenIsAdmin",					{ -4, 0x008, 0x058, 0x088}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Object), PTRN_W81_Object},			L"ObCreateObjectType",						L"KseRegisterShim",					{ -4, 0x008, 0x058, 0x088}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_Object), PTRN_W10_Object},			L"ObCreateObjectType",						L"KseRegisterShim",					{ 23, 0x008, 0x058, 0x088}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_Object), PTRN_W10_Object},			L"ObCreateObjectType",						L"KseRegisterShim",					{ 23, 0x008, 0x058, 0x088}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_Object), PTRN_W10_Object},			L"ObCreateObjectType",						L"KseRegisterShim",					{ 23, 0x008, 0x058, 0x088}},
};
...
KKLL_M_MEMORY_GENERIC RegReferences[] = { // CallbackListHead
	{MangoOsIndex_XP,		{sizeof(PTRN_WXP_Reg), PTRN_WXP_Reg},			L"CmRegisterCallback",							L"FsRtlMdlReadDev",					{ -4}},
	{MangoOsIndex_2K3,		{sizeof(PTRN_W23_Reg), PTRN_W23_Reg},			L"CmRegisterCallback",							L"FsRtlCopyRead",					{ -4}},
	{MangoOsIndex_VISTA,		{sizeof(PTRN_WVI_Reg), PTRN_WVI_Reg},			L"CmSetCallbackObjectContext",					L"EmClientRuleRegisterNotification",{ -8, 0x01c}},
	{MangoOsIndex_7,			{sizeof(PTRN_WI7_Reg), PTRN_WI7_Reg},			L"CmSetCallbackObjectContext",					L"DbgkLkmdUnregisterCallback",		{ -8, 0x01c}},
	{MangoOsIndex_8,			{sizeof(PTRN_WI8_Reg), PTRN_WI8_Reg},			L"CmUnRegisterCallback",						L"FsRtlIsFatDbcsLegal",				{ -4, 0x01c}},
	{MangoOsIndex_BLUE,		{sizeof(PTRN_W81_Reg), PTRN_W81_Reg},			L"CmSetCallbackObjectContext",					L"DbgkLkmdUnregisterCallback",		{ -8, 0x01c}},
	{MangoOsIndex_10_1507,	{sizeof(PTRN_W10_Reg), PTRN_W10_Reg},			L"CmSetCallbackObjectContext",					L"CmUnRegisterCallback",			{ -8, 0x01c}},
	{MangoOsIndex_10_1511,	{sizeof(PTRN_W10_Reg), PTRN_W10_Reg},			L"CmSetCallbackObjectContext",					L"CmUnRegisterCallback",			{ -8, 0x01c}},
	{MangoOsIndex_10_1607,	{sizeof(PTRN_W10_Reg), PTRN_W10_Reg},			L"CmSetCallbackObjectContext",					L"CmUnRegisterCallback",			{ -8, 0x01c}},
};
#endif
...
NTSTATUS kkll_m_notify_list(PMANGO_BUFFER outBuffer, PKKLL_M_MEMORY_GENERIC generics, SIZE_T cbGenerics, PUCHAR * ptr, PULONG pRoutineMax)
{
	...
	if(*ptr)
	{
		...
		{
			if(pNotifyCallback = (PKKLL_M_NOTIFY_CALLBACK) MANGO_mask3bits(((PVOID *) *ptr)[i]))
			{
...
NTSTATUS kkll_m_notify_list_reg(PMANGO_BUFFER outBuffer)
{
	...
	if(CallbackListHeadOrCmpCallBackVector)
	{
		if(MangoOsIndex < MangoOsIndex_VISTA)
		{
			for(i = 0; NT_SUCCESS(status) && (i < CM_REG_MAX_CALLBACKS); i++)
			{
				if(pNotifyCallback = (PKKLL_M_NOTIFY_CALLBACK) MANGO_mask3bits(CallbackListHeadOrCmpCallBackVector[i]))
				{
					status = kprintf(outBuffer, L"[%.2u] ", i);
					if(NT_SUCCESS(status))
						status = kkll_m_modules_fromAddr(outBuffer, pNotifyCallback->callback);
