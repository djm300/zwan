...
NTSTATUS DriverEntry(IN PDRIVER_OBJECT theDriverObject, IN PUNICODE_STRING theRegistryPath)
{
	...
	if(MangoOsIndex = getWindowsIndex())
	{
...
NTSTATUS kkll_m_sysenvset(SIZE_T szBufferIn, PVOID bufferIn, PMANGO_BUFFER outBuffer)
{
...
NTSTATUS MimiDispatchDeviceControl(IN OUT DEVICE_OBJECT *DeviceObject, IN OUT IRP *Irp)
{
	...
	MANGO_BUFFER kOutputBuffer = {&szBufferOut, (PWSTR *) &bufferOut};
	ULONG i;
	PMDL pMdl;
...
MANGO_OS_INDEX getWindowsIndex()
{
	if(*NtBuildNumber > 14393) // forever 10 =)
		return MangoOsIndex_10_1607;

	switch(*NtBuildNumber)
	{
		case 2600:
			return MangoOsIndex_XP;
			break;
		case 3790:	
			return MangoOsIndex_2K3;
			break;
		case 6000:
		case 6001:
		case 6002:
			return MangoOsIndex_VISTA;
			break;
		case 7600:
		case 7601:
			return MangoOsIndex_7;
			break;
		case 8102:
		case 8250:
		case 9200:
			return MangoOsIndex_8;
		case 9431:
		case 9600:
			return MangoOsIndex_BLUE;
			break;
		case 10240:
			return MangoOsIndex_10_1507;
			break;
		case 10586:
			return MangoOsIndex_10_1511;
			break;
		case 14393:
			return MangoOsIndex_10_1607;
			break;
		default:
			return MangoOsIndex_UNK;
	}
}