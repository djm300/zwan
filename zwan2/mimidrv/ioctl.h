...
typedef struct _MANGO_PROCESS_SIGNATURE_PROTECTION {
	UCHAR SignatureLevel;
	UCHAR SectionSignatureLevel;
	PS_PROTECTION Protection;
} MANGO_PROCESS_SIGNATURE_PROTECTION, *PMANGO_PROCESS_SIGNATURE_PROTECTION;

typedef struct _MIMIDRV_PROCESS_PROTECT_INFORMATION {
	ULONG processId;
	MANGO_PROCESS_SIGNATURE_PROTECTION SignatureProtection;
