...
VOID kuhl_m_sekurlsa_genericKeyOutput(struct _MANGO_CREDENTIAL_KEY * key, LPCWSTR sid);
...
typedef struct _MANGO_KRBTGT_CREDENTIAL_5 {
	PVOID unk0;
	PVOID unk1_key_salt;
	PVOID type;
	PVOID size;
	PVOID key;
} MANGO_KRBTGT_CREDENTIAL_5, *PMANGO_KRBTGT_CREDENTIAL_5;

typedef struct _MANGO_KRBTGT_CREDENTIALS_5 {
	DWORD unk0_ver;
	DWORD cbCred;
	LSA_UNICODE_STRING salt;
	MANGO_KRBTGT_CREDENTIAL_5 credentials[ANYSIZE_ARRAY];
} MANGO_KRBTGT_CREDENTIALS_5, *PMANGO_KRBTGT_CREDENTIALS_5;
