...
typedef struct _MANGO_KERBEROS_BUFFER {
	ULONG Length;
	PUCHAR Value;
} MANGO_KERBEROS_BUFFER, *PMANGO_KERBEROS_BUFFER;

typedef struct _MANGO_KERBEROS_TICKET {
...
} MANGO_KERBEROS_TICKET, *PMANGO_KERBEROS_TICKET;

void kuhl_m_kerberos_ticket_display(PMANGO_KERBEROS_TICKET ticket, BOOL withKey, BOOL encodedTicketToo);
...
BOOL kuhl_m_kerberos_ticket_isLongFilename(PMANGO_KERBEROS_TICKET ticket);
PCWCHAR kuhl_m_kerberos_ticket_etype(LONG eType);
PCWCHAR kuhl_m_kerberos_ticket_ctype(LONG cType);

void kuhl_m_kerberos_ticket_freeTicket(PMANGO_KERBEROS_TICKET ticket);
...
void kuhl_m_kerberos_ticket_freeMangoKerberosBuffer(PMANGO_KERBEROS_BUFFER pBuffer);

PBERVAL kuhl_m_kerberos_ticket_createAppKrbCred(PMANGO_KERBEROS_TICKET ticket, BOOL valueIsTicket);
PBERVAL kuhl_m_kerberos_ticket_createAppEncTicketPart(PMANGO_KERBEROS_TICKET ticket, LPCVOID PacAuthData, DWORD PacAuthDataSize);
